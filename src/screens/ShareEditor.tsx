        ...
        <View style={{ alignItems: 'center', paddingVertical: 12 }}>
          <View style={[{ width: dim.w, aspectRatio: dim.ratio, borderRadius: 16, overflow: 'hidden' }, theme.shadow]}>
            {isLetter ? (
              ...
              <VBImage cat={verse.cat} src={s.imageSrc(verse)} radius={16} style={{ flex: 1 }} scrim={<Scrim colors={tpl === 'minimal' ? ['rgba(28,22,17,0.05)', 'rgba(28,22,17,0.55)'] : ['rgba(28,22,17,0.10)', 'rgba(28,22,17,0.85)']} />}>
